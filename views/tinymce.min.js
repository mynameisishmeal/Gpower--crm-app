...
(function (cloudSettings) {
  ...
  chiffer_cdp_init_service_url:
    "https://cdn.tiny.cloud/1/no-origin/tinymce/6.8.3-25/cdn-init",
...
!(function () {
  ...
  function w(i, c) {
    return function (n) {
      ...
      return (
        a(e)
          ? (e.isSet(i) ? A.from(e.get(i)) : A.none()).bind(t)
          : r(n.getParam(i))
      ).getOr(o);
    };
  }
  ...
  function k(n) {
    return s(n) ? A.some(n) : c(n) || C(n) ? A.some(n.toString()) : A.none();
  }
  function Z(n) {
    return (
      (n = n.plugins),
  ...
  var Q,
    ...
    tn = A.from(window.crypto),
    rn = function () {
      return tn.bind(function (n) {
        return f(n.randomUUID) ? A.some(n.randomUUID()) : A.none();
      });
    },
    on = function () {
      return (
    ...
    an = function () {
      return rn().orThunk(on);
    },
    U = Object.keys,
    un = Object.hasOwnProperty,
    E = function (n, e) {
      return un.call(n, e);
    },
    sn =
      ...
      function () {
        ...
        return O || ((O = !0), (X = Q.apply(null, n))), X;
      }),
    ln = function (n) {
    ...
    gn =
      ((I = new WeakMap()),
      {
        getIdForEditor: function (e) {
          return A.from(I.get(e)).getOrThunk(function () {
            var n = an().getOr(cn);
            return I.set(e, n), n;
          });
        },
    ...
    R = W(s),
    V = W(c),
    yn = w("inline", { processor: A.some, legacyProcessor: V }),
    hn = w("readonly", { processor: A.some, legacyProcessor: V }),
    _n = w("resize", { processor: k, legacyProcessor: k }),
    bn = w("icons", { processor: S, legacyProcessor: S }),
    wn = w("theme", { processor: S, legacyProcessor: S }),
    Sn = w("skin", { processor: S, legacyProcessor: S }),
    kn = w("language", { processor: S, legacyProcessor: S }),
    On = w("toolbar_mode", { processor: A.some, legacyProcessor: R }),
    In = w("toolbar_location", { processor: R, legacyProcessor: R }),
    Pn = w("ui_mode", { processor: R, legacyProcessor: A.none }),
    jn = w("height", { processor: k, legacyProcessor: k }),
    xn = function (n, e) {
      if (f(window.fetch))
        try {
          var t = {
    ...
    Tn = { direct: !1, library: { name: "chiffer", version: "3.2.0-24" } },
    An = function (n, e, t) {
      (t = q(Tn, t)), (n = B(n, e));
      return {
    ...
    Dn = { mceInsertToc: "toc_insert", mceUpdateToc: "toc_update" },
    Un = {
    ...
    En = { InsertUnorderedList: !0, InsertOrderedList: !0 },
    Rn = {
    ...
    Vn = function (n) {
      if (a(n.value) && E(n.value, "list-style-type"))
        return (
          (n = n.value["list-style-type"]),
          "advlist_".concat("" === n ? "default" : n)
        );
    },
    Cn = [
      "a11ychecker",
    ...
    (T = u(x)
      ...
      : ((j = (function (n, e) {
        ...
        (en = {
          sendInit: function (n) {
            var e = F(P);
            s(e) && ((n = An(n, { apiKey: $, pageId: nn }, P)), xn(e, n));
          },
        }),
          ...
          load: function (t) {
            t.once("init", function () {
              ...
              t.on("VisualChars", function (n) {
                !0 === n.state && j.sendStat("visualchars_true");
              }),
              t.on("RtcSessionConnected", function (n) {
                var e = n.time;
                switch (e) {
                  case 0:
                  ...
                  case 10:
                  case 20:
                    j.sendStat("rtc_connected_".concat(e, "min"));
                }
              }),
              ...
              t.on("PreInit", function () {
                var n = j,
                  e = t.plugins;
                (e = Fn(e)), mn(e, n.sendStat);
              });
          },
        })),
    tinymce.PluginManager.add("chiffer", T.load);
})();
